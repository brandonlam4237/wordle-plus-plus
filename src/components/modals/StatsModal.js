...
function StatsModal({ closeStats }) {
        ...
        <div className="container">
          <div className="header">
            ...
            {settings.theme === "light" && (
              <img src={closeLight} onClick={closeStats} alt="close-button" />
            )}
            {settings.theme === "dark" && (
              <img src={closeDark} onClick={closeStats} alt="close-button" />
            )}
          </div>
